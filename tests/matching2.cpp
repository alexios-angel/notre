...
static_assert(NOTRE_CREATE("\\s").match(" "));
static_assert(NOTRE_CREATE("[[:space:]]").match(" "));
static_assert(NOTRE_CREATE("\\h").match(" "));
static_assert(NOTRE_CREATE("\\h").match(L"\x2009"));
static_assert(NOTRE_CREATE("\\v").match("\n"));

static_assert(NOTRE_CREATE("\\S").match("A"));
static_assert(NOTRE_CREATE("\\H").match("A"));
static_assert(NOTRE_CREATE("\\V").match("A"));
...
// issue #131
static_assert(NOTRE_CREATE("(|a)+").match("aaaaaa"sv));
...
static_assert(NOTRE_CREATE("[\\+\\-]").match("+"sv));
static_assert(NOTRE_CREATE("[\\+\\-]").match("-"sv));
static_assert(NOTRE_CREATE("[[:punct:]]").match("-"));
static_assert(NOTRE_CREATE("[[:punct:]]").match("+"));
static_assert(NOTRE_CREATE("[\\+\\-]").search("a+c"sv));
static_assert(NOTRE_CREATE("^(?=.*?[\\+\\-])[a-z [:punct:]]{8,}$").match("abcdefg-"sv));
static_assert(NOTRE_CREATE("^(?=.*?[\\+\\-])[a-z [:punct:]]{8,}$").match("abcdefg+"sv));
